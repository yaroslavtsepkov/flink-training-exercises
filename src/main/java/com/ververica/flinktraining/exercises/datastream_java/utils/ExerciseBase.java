...
public class ExerciseBase {
	...
	public final static String pathToRideData = "src/main/resources/data_nycTaxiRides.gz";
	public final static String pathToFareData = "src/main/resources/data_nycTaxiFares.gz";
